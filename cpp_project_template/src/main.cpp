...
private:
    void on_line_sensors_msg(std::shared_ptr<std_msgs::msg::UInt16MultiArray> msg)
    {
        if (msg->data.size() >= 2)
        {
            ...
            uint8_t left_motor_speed = 140;
            uint8_t right_motor_speed = 140;
            ...
            else if (left_value > 50)
            {
                ...
                left_motor_speed = 140 - 5;  // Zníženie ľavého motora o 5
                right_motor_speed = 140 + 5; // Zvýšenie pravého motora o 5
            }
            else if (right_value > 50)
            {
                // Ak pravý senzor zachytí čiaru, ľavý motor sa zvýši o 5, pravý sa zníži o 5
                left_motor_speed = 140 + 5;  // Zvýšenie ľavého motora o 5
                right_motor_speed = 140 - 5; // Zníženie pravého motora o 5
            }
